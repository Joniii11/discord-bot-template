...
export const data = commandFile({
    ...
    execute: async (cmdExecutor) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: "Username", value: targetUser.username, inline: true }, { name: "User ID", value: targetUser.id, inline: true }, { name: "Account Created", value: `<t:${Math.floor(targetUser.createdTimestamp / 1000)}:R>`, inline: true })
            .setColor(0x3498db)
